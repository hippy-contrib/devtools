...
export class CoverageView extends UI.Widget.VBox {
    ...
    _decorationManager;
    _resourceTreeModel;
    _coverageTypeComboBox;
    _coverageTypeComboBoxSetting;
    _toggleRecordAction;
    _toggleRecordButton;
    _inlineReloadButton;
    ...
    _filterInput;
    _typeFilterValue;
    _filterByTypeComboBox;
    _showContentScriptsSetting;
    _contentScriptsCheckbox;
    ...
    async _startRecording(options) {
        ...
        this._decorationManager = new CoverageDecorationManager(this._model);
